...
title: Doing and completing my first 75 Hard - Things I Learned
toc: false
---

I want to write a blog post on the following topics:

1. The 75 Hard Challenge. Things I learned and what I could improve.
2. Experience of being a scrum master for 2 weeks.
3. How I conducted a personal scrum that improved my productivity by 10-fold.
   I have a lot of points for each.
   I also want to write about The Walk the Board approach and how it led to better updates and how we did it.

Maybe I'll start with the 75 Hard Challenge first.
...
While on the walk, I would listen to podcasts. Initially, it was a podcast about 75 Hard, Jordan Peterson's advice on becoming tougher, Jocko podcast, etc. This primed my mindset to the challenge more and more.
...
2. Ego is the Enemy
   - I was thinking between the Dichotomy of Leadership and Ego is the Enemy, but I went with Ego is the Enemy because I thought I still had to improve before preaching to others.
...
I used the EveryDay app for capturing a daily photos. The app allows for clicking one photo a day in the same position as the previous time, and you get a nice video/gif export of all the photos.
...
- I workout out every day. At the start of the challenge, I as picking 7KG and 10Kgs arms. By the end of the challenge, I was able to pick 25 Kg per arm.
  ...
  - My weight dropped from around 83 KGs to 73 Kg. 10 Kgs reduced.
