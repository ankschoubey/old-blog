...
# **Optional**: Values are other concepts
...
1. Book: The subtle art of not giving a Fuck
    - Mark talks about the important of developing a value system. If our values are poorly choosen, we suffer.
    - He describes what constitute good and bad values, then goes on the describe 5 values based on "The backwards law". These values cover:
        ...
        5. Contemplating about details
    - The most important line I found was this (paraphrased): "This book will allows you to fall back and still be okay"
    - Mark's blog focuses on personal values too and he explores it many areas specially relationships.
    - [The Subtle Art of Not Giving a F*ck - Summarized by the Author](https://www.youtube.com/watch?v=lz8sUiXAnbs)
2. Jordan Peterson
    - I have consumed too many videos of Jordan and respect the man greatly.
    - According to Jordan, people should try develop a vision for themselves. And pick values accordingly.
    - Jordan is the reason why I got on this track. He advocates writing as a way of thinking through problems.
    - Jordan has written three books. Out of which the recent two are simpler and includes a set of 12 principles each.
        1. 12 Rules for Life.
            - Generates order and stability
        2. Beyond Order
            - Explores how to best with chaos. Chaos is the possibility of new and unknown.
    - Some of the values/principles Jordan advocates in these books are:
        1. 12 Rules for Life
            1. Tell the truth or atleast don't lie.
            2. Make friends with people who want the best for you.
            3. Set your house in perfect order before you critisize the work.
        2. Beyond Order
            1. Imagine who you could be and aim single mindedly at that.
            2. Do not do what you hate.
            3. Plan and work diligently to maintain the romance in your relationships.
    - Links:
...
3. Book: The 7 Habits of Highly Effective People
    ...
    - You could even say, the 7 habits are values.
        ...
        6. Synergize
        7. Sharpen the saw
    - The book also includes importants of defining purpose and values in Habit 2.
4. Naval Ravikant
    - Naval is one of the clearest thinker I have seen and a very practical one.
    - He doesn't bullshit. Tells the truth and has very simple heuristics.
    - According to Naval, people who are friends or in some other relationships have similar values.
    - Like: 
        - If you are conflicted between two choices and each has equal weight, pick the hardest one.
        - If you can't decide, the answer is No.
        - Always choose long term over short term. Friends. Relationships. Business partners. etc
    - Links:
...
5. Shwetabh Gangwar
    - Shwetabh is a YouTuber with many videos on practical daily topic.
    ...
    - His book "The Rudest Book Ever" focuses on useful perspectives. Like:
        - People are weird
        - Rejection is normal. Since people are weird you don't need to go to find out.
        - Failure is normal
    - Links:
        - [Shwetabh's YouTube channel](https://www.youtube.com/c/ShwetabhGangwar1/videos)
5. YouTube videos. There are many youtube videos on the topics. Just search "Personal Values"
