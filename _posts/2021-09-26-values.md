...
Using the process about for yourself and for others you might come across both.

Often other peoples feedback is also a good place since we might be blinded by our own.

Some values seem good on the surface but are bad.

For example: Being exesivenly 
